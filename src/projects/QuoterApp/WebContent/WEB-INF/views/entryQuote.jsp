	...
	<div class="use-sidebar sidebar-at-left" id="entry">
		...
		<div class="content">
			...
			<div class="quote-tables">
				...
				<div class="matrix">
		    		<form:label path="terms"><spring:message code="customer.information.terms" /><span class="red">&nbsp;*</span></form:label>
					<form:input path="terms" value="${command.terms}"/>&nbsp;<spring:message code="customer.information.termsMonths" />
				</div>
